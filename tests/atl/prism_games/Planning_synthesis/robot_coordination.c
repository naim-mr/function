...
// ---------------------------------------------------------------------
// Two robots move along a corridor toward their goal cells (x1,x2 >= goal,
// where the goal distance is arbitrary -- not fixed in advance).
...
//   -atl "<r1,r2>F{AND{x1 >= goal}{x2 >= goal}}"
// =====================================================================

int main() {
    int goal = input("env");   // goal cell: arbitrary, not fixed in advance
