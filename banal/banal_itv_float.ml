...
let equal ((l1, h1) : t) ((l2, h2) : t) : bool = D.equal l1 l2 && D.equal h1 h2
let subseteq ((l1, h1) : t) ((l2, h2) : t) : bool = D.geq l1 l2 && D.leq h1 h2
...
let bound_mul mul x y = if D.sign x = 0 || D.sign y = 0 then D.zero else mul x y
