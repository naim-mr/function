...
list=( 
  ...
  "-domain polyhedra -ordinals 3  -refine -vulnerability" 
  # "-domain polyhedra -cda 1  -ordinals 3 -vulnerability" 
  "-domain polyhedra -ordinals 3 -cda 3  -vulnerability"
...
treat_examples() {
  ...
  # Iterate analysis on all files 
    ...
    echo "<tr>" >> $index_html
    echo "<td><a href=\"${filename}.html\"><pre>${filename}</pre></a></td>" >> $index_html
    echo  "\\\\" >> $index_tex
